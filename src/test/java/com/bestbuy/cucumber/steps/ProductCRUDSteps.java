...
public class ProductCRUDSteps {
    ...
    public void userCreatesNewProductRecordWith(String _name, String type, double price, String upc,int shipping, String description, String manufacturer, String model, String url, String image)  {
    ...
    public void userCanSearchNewRecordUsingProduct(String _name)  {
